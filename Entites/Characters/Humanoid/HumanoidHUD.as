...
{
	AddIconToken("$l_hand$", "LHand.png", Vec2f(5, 5), 0);	
	AddIconToken("$r_hand$", "RHand.png", Vec2f(5, 5), 0);	
	AddIconToken("$r_leg$", "RLeg.png", Vec2f(7, 7), 0);
	AddIconToken("$head$", "Head.png", Vec2f(9, 7), 0);
	AddIconToken("$l_leg$", "LLeg.png", Vec2f(7, 7), 0);
}
