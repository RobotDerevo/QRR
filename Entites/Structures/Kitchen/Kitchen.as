...
void onInit( CBlob@ this )
{
	...
	}
	{
		...
		AddRequirement( requirements, "blob", "bucket", "Bucket", 1 );
	...
	}
	{
		...
		AddRequirement( requirements, "blob", "bucket", "Bucket", 1 );
		addFoodItem( this, "Cake", 5, "A cake with very good tasty", 20, 1, @requirements );
	}
	{
		CBitStream requirements;
		AddRequirement( requirements, "blob", "grain", "Grain", 1 );
		AddRequirement( requirements, "blob", "bucket", "Bucket", 1 );
		AddRequirement( requirements, "blob", "steak", "Steak", 1 );
		addFoodItem( this, "Classical Meat Burger", 6, "A Classic meat burger.", 30, 1, @requirements );
	}
	{
		CBitStream requirements;
		AddRequirement( requirements, "blob", "grain", "Grain", 1 );
		AddRequirement( requirements, "blob", "bucket", "Bucket", 1 );
		AddRequirement( requirements, "blob", "fishy", "Fishy", 1 );
		addFoodItem( this, "Classic Beer", 7, "A Classic Fresh beer.", 30, 1, @requirements );
	}
