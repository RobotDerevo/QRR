...
void GrowSprite(CSprite@ this, TreeVars@ vars)
{
	...
	for (uint i = 0; i < segments.length; i++)
	{
		...
		if (segment !is null && !segment.gotsprites)
		{
			...
			{
				CSpriteLayer@ newsegment = this.addSpriteLayer("segment " + i, texture, 32, 16, 0, 0);
			...
			else if (segment.grown_times == 3 && i > 0 && i != vars.max_height - 1)
			{
				...
				{
					CSpriteLayer@ newsegment = this.addSpriteLayer("leaves " + i + " " + spriteindex, texture , 32, 32, 0, 0);
			...
			{
				f32 flipsign = 1.0f;
				CSpriteLayer@ newsegment = this.addSpriteLayer("roots", texture, 32, 16, 0, 0);
			...
			{
				CSpriteLayer@ newsegment = this.addSpriteLayer("extra leaves top", texture, 32, 32, 0, 0);
			...
			else if (segment.grown_times == 5 && i == vars.max_height - 1) //top of the tree
			{
				...
				{
					CSpriteLayer@ newsegment = this.addSpriteLayer("leaves " + i + " " + 3, texture, 64, 32, 0, 0);
				...
				{
					CSpriteLayer@ newsegment = this.addSpriteLayer("leaves " + i + " " + 4, texture, 64, 32, 0, 0);
